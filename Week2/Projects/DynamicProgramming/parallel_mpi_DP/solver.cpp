...
MatrixXd ValIt(MatrixXd ValOld) {
     ...
     */
                ...
                /* Two options here:
                 *
                 * TODO: This is where you need to start parallelizing. I think this is a good 
                 * place to start implementing MPI. All you have to do is have ValOld in all the 
                 * processes you have!!
     
                 * TODO: This can be done using OpenMP I think. In each process, you want to 
                 * start n threads here to compute the values for ValNew 
                 */
