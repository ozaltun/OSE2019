...
/* The following function vectorizes the utility function. That is, it receives a consumption vector
...
/* Define Transition Function.
 For each theta, p(theta) returns the probability distribution over the thetas given that we are at state theta.
 */
...
// Given the number of capital states and level of discretization, the following constructs the kgrid
